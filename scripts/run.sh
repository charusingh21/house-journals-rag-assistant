...
export RAG_MODEL_PROFILES="${RAG_MODEL_PROFILES:-fast=nvidia/nemotron-3-nano-30b-a3b|450|Fast demo;balanced=nvidia/llama-3.3-nemotron-super-49b-v1.5|700|Balanced;deep=nvidia/llama-3.3-nemotron-super-49b-v1.5|1100|Deep research}"
